...
def _load_model_and_alphabet_core_v1(model_data):
    import fairesm  # since fairesm.inverse_folding is imported below, you actually have to re-import fairesm here

    alphabet = fairesm.Alphabet.from_architecture(model_data["args"].arch)
    ...
    if model_data["args"].arch == "roberta_large":
        ...
        model_type = fairesm.ProteinBertModel
        ...
        model_type = fairesm.MSATransformer

    elif "invariant_gvp" in model_data["args"].arch:
        import fairesm.inverse_folding

        model_type = fairesm.inverse_folding.gvp_transformer.GVPTransformerModel
...
def _load_model_and_alphabet_core_v2(model_data):
    ...
    alphabet = fairesm.data.Alphabet.from_architecture("ESM-1b")
    model = ESM2(
...
def esm_msa1_t12_100M_UR50S():
    warnings.warn(
        ...
        "please use ESM-MSA-1b: fairesm.pretrained.esm_msa1b_t12_100M_UR50S()",
    )
...
def esmfold_v0():
    ...
    return fairesm.esmfold.v1.pretrained.esmfold_v0()
...
def esmfold_v1():
    ...
    """
    import fairesm.esmfold.v1.pretrained
    return fairesm.esmfold.v1.pretrained.esmfold_v1()
...
def esmfold_structure_module_only_8M():
    ...
    """
    import fairesm.esmfold.v1.pretrained
    return fairesm.esmfold.v1.pretrained.esmfold_structure_module_only_8M()
...
def esmfold_structure_module_only_8M_270K():
    ...
    """
    import fairesm.esmfold.v1.pretrained
    return fairesm.esmfold.v1.pretrained.esmfold_structure_module_only_8M_270K()
...
def esmfold_structure_module_only_35M():
    ...
    """
    import fairesm.esmfold.v1.pretrained
    return fairesm.esmfold.v1.pretrained.esmfold_structure_module_only_35M()
...
def esmfold_structure_module_only_35M_270K():
    ...
    """
    import fairesm.esmfold.v1.pretrained
    return fairesm.esmfold.v1.pretrained.esmfold_structure_module_only_35M_270K()
...
def esmfold_structure_module_only_150M():
    ...
    """
    import fairesm.esmfold.v1.pretrained
    return fairesm.esmfold.v1.pretrained.esmfold_structure_module_only_150M()
...
def esmfold_structure_module_only_150M_270K():
    ...
    """
    import fairesm.esmfold.v1.pretrained
    return fairesm.esmfold.v1.pretrained.esmfold_structure_module_only_150M_270K()
...
def esmfold_structure_module_only_650M():
    ...
    """
    import fairesm.esmfold.v1.pretrained
    return fairesm.esmfold.v1.pretrained.esmfold_structure_module_only_650M()
...
def esmfold_structure_module_only_650M_270K():
    ...
    """
    import fairesm.esmfold.v1.pretrained
    return fairesm.esmfold.v1.pretrained.esmfold_structure_module_only_650M_270K()
...
def esmfold_structure_module_only_3B():
    ...
    """
    import fairesm.esmfold.v1.pretrained
    return fairesm.esmfold.v1.pretrained.esmfold_structure_module_only_3B()
...
def esmfold_structure_module_only_3B_270K():
    ...
    """
    import fairesm.esmfold.v1.pretrained
    return fairesm.esmfold.v1.pretrained.esmfold_structure_module_only_3B_270K()
...
def esmfold_structure_module_only_15B():
    ...
    """
    import fairesm.esmfold.v1.pretrained
    return fairesm.esmfold.v1.pretrained.esmfold_structure_module_only_15B()
