...
def test_esm1b_alphabet():
    ...
    _, alphabet = fairesm.pretrained.esm1b_t33_650M_UR50S()
...
def test_esm1v_alphabet():
    ...
    _, alphabet = fairesm.pretrained.esm1v_t33_650M_UR90S_1()
    _test_esm1b(alphabet)
    _test_esm1b_truncation(alphabet)
...
def test_esm1_msa1b_alphabet():
    ...
    # Load ESM-1b model
    _, alphabet = fairesm.pretrained.esm_msa1b_t12_100M_UR50S()
    batch_converter = alphabet.get_batch_converter()
